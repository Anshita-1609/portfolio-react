...
const Projects = () => {
    return (
        <div id="projects" className="bg-gray-100 dark:bg-gray-900 p-10">
            <h2 className="text-4xl font-bold text-center text-gray-800 dark:text-pink-600 mb-10">My Projects</h2>
